...
| Correct via flexible match (alias diferente) | 77 |
...
**Erro:** Falha SQL: Error code: 429 - {'error': {'message': 'Rate limit reached for gpt-4o in organization org-aK8aWLtYpE9ckhsyipz78Ewp on tokens per min (TPM): Limit 30000, Used 26979, Requested 3219. Please try again in 396ms. Visit https://platform.openai.com/account/rate-limits to learn more.', 'type': 'tokens', 'param': None, 'code': 'rate_limit_exceeded'}}
