...
|---|---|
| Total queries | 118 |
| Correct (EA numerator) | 96 |
| **Execution Accuracy (EA)** | **81.4%** |
| Wilson IC 95% | [73.4%, 87.4%] |
...
**Resultado:** `Linha 1: got={'cid_principal': 'T509', 'total_internacoes': 1, 'total_obitos': 1.0, 'taxa_mortalidade_pct': 100.0} exp={'cid_principal': 'S062', 'total_internacoes': 70, 'total_obitos': 21, 'taxa_mortalidade_pct': 30.0}`
**TTA:** 7176ms
...
- **Q18** (Epidemiológica Complexa): Linha não encontrada: {'faixa_etaria': '0-17', 'total': 3619}
  ...
  CASE
    ...
    WHEN idade_paciente BETWEEN 18 AND 59 THEN '18-59'
    ELSE '...`
- **Q19** (Epidemiológica Complexa): Linha 1: got={'cid_principal': 'T509', 'total_internacoes': 1, 'total_obitos': 1.0, 'taxa_mortalidade_pct': 100.0} exp={'cid_principal': 'S062', 'total_internacoes': 70, 'total_obitos': 21, 'taxa_mortalidade_pct': 30.0}
