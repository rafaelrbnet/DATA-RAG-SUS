...
**Resultado:** `Linha 1: got={'cid_principal': 'S12', 'total_internacoes': 1, 'total_obitos': 1.0, 'taxa_mortalidade_pct': 100.0} exp={'cid_principal': 'S062', 'total_internacoes': 70, 'total_obitos': 21, 'taxa_mortalidade_pct': 30.0}`
**TTA:** 7174ms
...
WHERE sistema = 'SIH'
  ...
  AND (icd_group = 'M00-M99' OR icd_group = 'S00-T98')
GROUP BY mes_cmpt, sexo_paciente
ORDER BY mes_cmpt, total_internacoes DESC;
```

**Resultado:** `Linha 1: got={'mes_cmpt': 1, 'sexo_paciente': 'M', 'total_internacoes': 3151} exp={'mes_cmpt': 1, 'sexo_paciente': 'F', 'total': 2058}`
**TTA:** 11665ms
...
- **Q19** (Epidemiológica Complexa): Linha 1: got={'cid_principal': 'S12', 'total_internacoes': 1, 'total_obitos': 1.0, 'taxa_mortalidade_pct': 100.0} exp={'cid_principal': 'S062', 'total_internacoes': 70, 'total_obitos': 21, 'taxa_mortalidade_pct': 30.0}
...
WHERE sistema = 'SIA'
  AND uf_origem = 'SP'
  AND ...`
- **Q113** (Temporal/Comparativa): Linha 1: got={'mes_cmpt': 1, 'sexo_paciente': 'M', 'total_internacoes': 3151} exp={'mes_cmpt': 1, 'sexo_paciente': 'F', 'total': 2058}
  SQL: `SELECT mes_cmpt,
  sexo_paciente,
  COUNT(DISTINCT n_aih) AS total_internacoes
FROM processed
