...
**Resultado:** `Linha 1: got={'cid_principal': 'S063', 'permanencia_media_dias': 16.358974359, 'total_internacoes': 78} exp={'cid_principal': 'S063', 'internacoes': 78, 'permanencia_media': 16.4}`
**TTA:** 6077ms
...
- **Q75** (Epidemiológica Complexa): Número de linhas: got=16 exp=6
  ...
  CASE
    ...
    WHEN idade_paciente < 30 THEN '18-29'
    WHEN i...`
- **Q76** (Epidemiológica Complexa): Linha 1: got={'cid_principal': 'S063', 'permanencia_media_dias': 16.358974359, 'total_internacoes': 78} exp={'cid_principal': 'S063', 'internacoes': 78, 'permanencia_media': 16.4}
  SQL: `SELECT
  cid_principal,
  AVG(dias_perm) AS permanencia_media_dias,
  COUNT(DISTINCT n_aih) AS total_internacoes
