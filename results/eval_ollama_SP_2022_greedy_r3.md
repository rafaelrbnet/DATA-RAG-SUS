...
**Resultado:** `Linha 1: got={'cid_principal': 'T056', 'total_obitos': 1, 'total_internacoes': 1, 'taxa_mortalidade': 100.0} exp={'cid_principal': 'S062', 'total_internacoes': 70, 'total_obitos': 21.0, 'taxa_mortalidade_pct': 30.0}`
**TTA:** 14849ms
...
**Resultado:** `got=2755130 exp=173.1`
**TTA:** 8654ms
...
- **Q19** (Epidemiológica Complexa): Linha 1: got={'cid_principal': 'T056', 'total_obitos': 1, 'total_internacoes': 1, 'taxa_mortalidade': 100.0} exp={'cid_principal': 'S062', 'total_internacoes': 70, 'total_obitos': 21.0, 'taxa_mortalidade_pct': 30.0}
  SQL: `SELECT 
  cid_principal,
  COUNT(CASE WHEN morte = 1 THEN n_aih END) AS total_obitos,
...
- **Q79** (Epidemiológica Complexa): Número de linhas: got=5 exp=3
  ...
  CASE
    ...
    WHEN idade_paciente BETWEEN 18 AND 34 THEN '18-34'
    WHEN i...`
- **Q83** (Epidemiológica Complexa): got=2755130 exp=173.1
  SQL: `SELECT 
  cnes_estabelecimento,
  COUNT(DISTINCT n_aih) AS internacoes
FROM processed
