...
|---|---|
| Total queries | 118 |
| Correct (EA numerator) | 83 |
| **Execution Accuracy (EA)** | **70.3%** |
| Wilson IC 95% | [61.6%, 77.8%] |
| Correct via flexible match (alias diferente) | 67 |
| API errors / timeouts | 9 |
| Mean Time-to-Answer | 46.9s |
...
|---|---:|---:|---:|
| Epidemiológica Simples | 29 | 33 | 87.9% |
...
**Erro:** Falha DuckDB: Binder Error: Referenced column "uti" not found in FROM clause!
Candidate bindings: "uti_int_to", "uti_mes_to", "dt_inter", "dt_saida", "munic_mov"
...
SELECT 
  ...
  (SELECT COUNT(DISTINCT n_aih) 
   ...
   WHERE sistema = 'SIH' 
     ...
     AND ano_cmpt = 2022 
     AND idade >= 60 
     AND (icd_group = 'M00-M99' OR icd_group = 'S00-T98')) AS total_internacoes_idosos
FROM processed
WHERE sistema = 'SIH' 
  AND uf_origem = 'SP' 
  AND ano_cmpt = 2022 
...
**Erro:** Falha DuckDB: Binder Error: Referenced column "morto" not found in FROM clause!
Candidate bindings: "morte", "val_ortp", "pa_motsai", "nome_proced", "mun_res_nome"
...
LINE 3:     WHEN idade BETWEEN 0 AND 17 THEN '0-17'
                 ^
...
WHERE sistema = 'SIH'
  ...
  AND ano_cmpt = 2022
  AND (icd_group = 'M00-M99' OR icd_group = 'S00-T98')
  AND uti_passagem = 'S';  -- Assuming there's a column indicating UTI passage
```

**Erro:** Falha DuckDB: Binder Error: Referenced column "uti_passagem" not found in FROM clause!
Candidate bindings: "dt_saida", "dias_perm", "cid_asso", "uf_origem", "etnia_paciente"

LINE 7:   AND uti_passagem = 'S';  -- Assuming there's a column indicating...
              ^
...
- **Q14** (Epidemiológica Simples): Falha DuckDB: Binder Error: Referenced column "uti" not found in FROM clause!
Candidate bindings: "uti_int_to", "uti_mes_to", "dt_inter", "dt_saida", "munic_mov"

LINE 7:   AND uti > 0;
              ^
  SQL: `SELECT COUNT(DISTINCT n_aih) AS total_internacoes_com_uti
FROM processed
WHERE sistema = 'SIH'
  AND uf_origem = 'SP'
  ...`
...
- **Q45** (Temporal/Comparativa): Número de linhas: got=12 exp=24
  ...
  COUNT(DISTINCT CASE WHEN icd_group = 'S00-T98' THEN n_aih END) AS trauma_internacoes,
  COUNT(DISTI...`
- **Q46** (Temporal/Comparativa): Falha DuckDB: Binder Error: Referenced column "morto" not found in FROM clause!
Candidate bindings: "morte", "val_ortp", "pa_motsai", "nome_proced", "mun_res_nome"
...
WHERE sistema = 'SIH'
  AND uf_origem = 'SP'
 ...`
- **Q55** (Epidemiológica Simples): Falha DuckDB: Binder Error: Referenced column "idade" not found in FROM clause!
Candidate bindings: "idademax", "idademin", "idade_paciente", "diagsec1", "diagsec2"
...
WHERE sistema = 'SIA'
  AND uf_origem = 'SP'
  AND ano_cmpt = 2022...`
- **Q59** (Epidemiológica Simples): Falha DuckDB: Binder Error: Referenced column "idade" not found in FROM clause!
Candidate bindings: "idademax", "idademin", "idade_paciente", "diagsec1", "diagsec2"
...
- **Q75** (Epidemiológica Complexa): Número de linhas: got=10 exp=6
  ...
  CASE
    ...
    WHEN idade_paciente < 35 THEN '18-34'
    WHEN i...`
- **Q77** (Epidemiológica Complexa): Falha DuckDB: Binder Error: Referenced column "idade" not found in FROM clause!
Candidate bindings: "idademax", "idademin", "idade_paciente", "diagsec1", "diagsec2"
...
- **Q79** (Epidemiológica Complexa): Número de linhas: got=7 exp=3
  ...
  CASE
    ...
    WHEN idade_paciente < 30 THEN '18-29'
    WHEN idade_paciente...`
- **Q82** (Epidemiológica Complexa): Falha DuckDB: Binder Error: Referenced column "idade" not found in FROM clause!
Candidate bindings: "idademax", "idademin", "idade_paciente", "diagsec1", "diagsec2"
...
- **Q87** (Financeira): Falha DuckDB: Binder Error: Referenced column "uti_passagem" not found in FROM clause!
Candidate bindings: "dt_saida", "dias_perm", "cid_asso", "uf_origem", "etnia_paciente"
...
WHERE sistema = 'SIH'
  AND uf_origem = 'SP...`
- **Q89** (Financeira): Falha DuckDB: Binder Error: Referenced column "idade" not found in FROM clause!
Candidate bindings: "idademax", "idademin", "idade_paciente", "diagsec1", "diagsec2"
