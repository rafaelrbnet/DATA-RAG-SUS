...
|---|---|
| Total queries | 118 |
| Correct (EA numerator) | 85 |
| **Execution Accuracy (EA)** | **72.0%** |
| Wilson IC 95% | [63.3%, 79.3%] |
| Correct via flexible match (alias diferente) | 62 |
| API errors / timeouts | 0 |
| Mean Time-to-Answer | 11.7s |
...
| Temporal/Comparativa | 19 | 28 | 67.9% |
...
**Resultado:** `Linha 1: got={'cid_principal': 'S45', 'total_obitos': 1, 'total_internacoes': 1, 'taxa_mortalidade': 100.0} exp={'cid_principal': 'S062', 'total_internacoes': 70, 'total_obitos': 21.0, 'taxa_mortalidade_pct': 30.0}`
**TTA:** 17141ms
...
**Resultado:** `Linha 1: got={'proporcao_internacoes_outro_municipio': 56.4} exp={'total_internacoes': 65970, 'deslocamento_intermunicipal': 37219.0, 'pct_deslocamento': 56.4}`
**TTA:** 12870ms
...
**Resultado:** `Linha 1: got={'mes_cmpt': 1, 'total_fraturas_femur': 2220, 'pct_total': 7.6} exp={'mes_cmpt': 1, 'total_fraturas': 2220}`
**TTA:** 11370ms
...
**Resultado:** `got=2078775 exp=173.1`
**TTA:** 11288ms
...
**Resultado:** `Linha 1: got={'cod_procedimento': '0702100048', 'quantidade': 15807, 'custo_total': 46893518.21} exp={'cod_procedimento': '0701020369', 'custo_total': 1201460.4}`
**TTA:** 10745ms
...
**Resultado:** `Linha 1: got={'mes_cmpt': 7, 'total_obitos': 816} exp={'mes_cmpt': 10, 'total_obitos': 224}`
**TTA:** 9104ms
...
**Resultado:** `Linha 1: got={'mes_cmpt': 1, 'sexo_paciente': 'F', 'total_procedimentos': 2589, 'pct': 43.9} exp={'mes_cmpt': 1, 'sexo_paciente': 'F', 'total': 2589}`
**TTA:** 15077ms
...
- **Q19** (Epidemiológica Complexa): Linha 1: got={'cid_principal': 'S45', 'total_obitos': 1, 'total_internacoes': 1, 'taxa_mortalidade': 100.0} exp={'cid_principal': 'S062', 'total_internacoes': 70, 'total_obitos': 21.0, 'taxa_mortalidade_pct': 30.0}
  SQL: `SELECT 
  cid_principal,
  COUNT(CASE WHEN morte = 1 THEN n_aih END) AS total_obitos,
...
WHERE sistema = 'SIH'
  AND uf_orige...`
- **Q28** (Epidemiológica Complexa): Linha 1: got={'proporcao_internacoes_outro_municipio': 56.4} exp={'total_internacoes': 65970, 'deslocamento_intermunicipal': 37219.0, 'pct_deslocamento': 56.4}
  SQL: `SELECT 
...
- **Q45** (Temporal/Comparativa): Número de linhas: got=12 exp=24
  ...
  COUNT(DISTINCT CASE WHEN icd_group = 'S00-T98' THEN n_aih END) AS trauma_internacoes,
  COUNT(DIST...`
- **Q49** (Temporal/Comparativa): Linha 1: got={'mes_cmpt': 1, 'total_fraturas_femur': 2220, 'pct_total': 7.6} exp={'mes_cmpt': 1, 'total_fraturas': 2220}
  SQL: `SELECT 
  mes_cmpt,
  COUNT(*) AS total_fraturas_femur,
  ROUND(100.0 * COUNT(*) / SUM(COUNT(*)) OVER (), 1) AS pct_tota...`
...
- **Q79** (Epidemiológica Complexa): Número de linhas: got=5 exp=3
  ...
  CASE
    ...
    WHEN idade_paciente BETWEEN 18 AND 34 THEN '18-34'
    WHEN i...`
- **Q83** (Epidemiológica Complexa): got=2078775 exp=173.1
  SQL: `SELECT 
  cnes_estabelecimento,
  COUNT(DISTINCT n_aih) AS internacoes
FROM 
...
- **Q93** (Financeira): Número de linhas: got=5 exp=3
  ...
  CASE 
    ...
    WHEN idade_paciente BETWEEN 18 AND 34 THEN '18-34'
    WHEN...`
- **Q99** (Financeira): Linha 1: got={'cod_procedimento': '0702100048', 'quantidade': 15807, 'custo_total': 46893518.21} exp={'cod_procedimento': '0701020369', 'custo_total': 1201460.4}
  SQL: `SELECT cod_procedimento,
       COUNT(*) AS quantidade,
       ROUND(SUM(COALESCE(custo_total, 0)), 2) AS custo_total
FR...`
- **Q101** (Temporal/Comparativa): Linha 1: got={'mes_cmpt': 7, 'total_obitos': 816} exp={'mes_cmpt': 10, 'total_obitos': 224}
  SQL: `SELECT mes_cmpt,
  COUNT(*) AS total_obitos
FROM processed
WHERE sistema = 'SIH'
  AND uf_origem = 'SP'
  AND ano_cmpt =...`
- **Q106** (Temporal/Comparativa): Linha 1: got={'mes_cmpt': 1, 'sexo_paciente': 'F', 'total_procedimentos': 2589, 'pct': 43.9} exp={'mes_cmpt': 1, 'sexo_paciente': 'F', 'total': 2589}
  SQL: `SELECT 
  mes_cmpt,
  sexo_paciente,
  COUNT(*) AS total_procedimentos,
