...
```sql
SELECT 
    COUNT(DISTINCT CASE WHEN idade_paciente >= 60 AND cid_principal LIKE 'S72%' THEN n_aih END) AS internacoes_fratura_femur_idosos,
    COUNT(DISTINCT n_aih) AS total_internacoes
FROM 
    processed
WHERE 
...
**Resultado:** `Linha 1: got={'internacoes_fratura_femur_idosos': 19117, 'total_internacoes': 29356} exp={'total_s72': 29356, 's72_idosos': 19120, 'pct_idosos': 65.1}`
**TTA:** 4031ms
...
**Resultado:** `got=13990374.039999994 exp=13990374.04`
**TTA:** 3880ms
...
- **Q22** (Epidemiológica Complexa): Linha 1: got={'internacoes_fratura_femur_idosos': 19117, 'total_internacoes': 29356} exp={'total_s72': 29356, 's72_idosos': 19120, 'pct_idosos': 65.1}
  SQL: `SELECT 
    COUNT(DISTINCT CASE WHEN idade_paciente >= 60 AND cid_principal LIKE 'S72%' THEN n_aih END) AS internacoes_f...`
