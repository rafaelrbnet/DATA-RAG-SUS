...
**Resultado:** `Linha 1: got={'cid_principal': 'S12', 'taxa_mortalidade': 100.0} exp={'cid_principal': 'S062', 'total_internacoes': 70, 'total_obitos': 21, 'taxa_mortalidade_pct': 30.0}`
**TTA:** 5893ms
...
- **Q18** (Epidemiológica Complexa): Linha não encontrada: {'faixa_etaria': '0-17', 'total': 3619}
  ...
  CASE
    ...
    WHEN idade_paciente BETWEEN 18 AND 59 THEN '18-59'
    ELSE ...`
- **Q19** (Epidemiológica Complexa): Linha 1: got={'cid_principal': 'S12', 'taxa_mortalidade': 100.0} exp={'cid_principal': 'S062', 'total_internacoes': 70, 'total_obitos': 21, 'taxa_mortalidade_pct': 30.0}
