...
| API errors / timeouts | 7 |
| Mean Time-to-Answer | 28.1s |
...
|---|---:|---:|---:|
| Epidemiológica Simples | 28 | 33 | 84.8% |
...
SELECT
  CASE
    ...
    WHEN dias_perm BETWEEN 11 AND 20 THEN '11-20 dias'
    WHEN dias_perm BETWEEN 21 AND 30 THEN '21-30 dias'
    ELSE '31+ dias'
...
WHERE sistema = 'SIH'
  AND uf_origem = 'SP'
  AND ano_...`
- **Q67** (Epidemiológica Simples): Falha DuckDB: Binder Error: Referenced column "morto" not found in FROM clause!
Candidate bindings: "morte", "val_ortp", "pa_motsai", "nome_proced", "mun_res_nome"
