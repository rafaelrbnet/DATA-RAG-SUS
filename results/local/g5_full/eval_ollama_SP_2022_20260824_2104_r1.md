...
**Resultado:** `Linha 1: got={'cid_principal': 'S12', 'obitos': 1, 'total_internacoes': 1, 'taxa_mortalidade': 100.0} exp={'cid_principal': 'S062', 'total_internacoes': 70, 'total_obitos': 21, 'taxa_mortalidade_pct': 30.0}`
**TTA:** 14638ms
...
SELECT
  CASE
    WHEN dias_perm BETWEEN 0 AND 1 THEN '0-1 dia'
    WHEN dias_perm BETWEEN 2 AND 5 THEN '2-5 dias'
    ...
    WHEN dias_perm BETWEEN 26 AND 30 THEN '26-30 dias'
...
**Resultado:** `Número de linhas: got=8 exp=4`
**TTA:** 24255ms
...
- **Q18** (Epidemiológica Complexa): Linha não encontrada: {'faixa_etaria': '0-17', 'total': 3619}
  ...
  CASE
    WHEN idade_paciente BETWEEN 0 AND 17 THEN '0-17'
    WHEN idade_paciente BETWEEN 18 AND 59 THEN '18-59...`
- **Q19** (Epidemiológica Complexa): Linha 1: got={'cid_principal': 'S12', 'obitos': 1, 'total_internacoes': 1, 'taxa_mortalidade': 100.0} exp={'cid_principal': 'S062', 'total_internacoes': 70, 'total_obitos': 21, 'taxa_mortalidade_pct': 30.0}
  SQL: `SELECT
  cid_principal,
  COUNT(DISTINCT CASE WHEN morte = 1 THEN n_aih END) AS obitos,
...
- **Q83** (Epidemiológica Complexa): got=2221.0 exp=173.1
  SQL: `SELECT
  cnes_estabelecimento,
  ROUND(COUNT(DISTINCT n_aih) / COUNT(DISTINCT cod_munic_estabelecimento), 2) AS media_in...`
- **Q84** (Epidemiológica Complexa): Número de linhas: got=8 exp=4
  SQL: `SELECT
  CASE
    WHEN dias_perm BETWEEN 0 AND 1 THEN '0-1 dia'
    WHEN dias_perm BETWEEN 2 AND 5 THEN '2-5 dias'
