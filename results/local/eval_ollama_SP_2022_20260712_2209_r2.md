...
**Resultado:** `Linha 1: got={'pct_internacoes_outro_municipio': 56.4} exp={'total_internacoes': 65970, 'deslocamento_intermunicipal': 37219.0, 'pct_deslocamento': 56.4}`
**TTA:** 10444ms
...
**Resultado:** `Linha 1: got={'mes_cmpt': 1, 'total_ortopedico': 5898} exp={'mes_cmpt': 1, 'sistema': 'SIA', 'total': 5898}`
**TTA:** 9053ms
...
WHERE sistema = 'SIH'
  AND uf_orige...`
- **Q28** (Epidemiológica Complexa): Linha 1: got={'pct_internacoes_outro_municipio': 56.4} exp={'total_internacoes': 65970, 'deslocamento_intermunicipal': 37219.0, 'pct_deslocamento': 56.4}
  SQL: `SELECT 
  ROUND(100.0 * COUNT(CASE WHEN cod_munic_residencia != cod_munic_estabelecimento THEN n_aih END) / COUNT(DISTIN...`
- **Q29** (Epidemiológica Complexa): Linha 1: got={'mes_cmpt': 1, 'total_ortopedico': 5898} exp={'mes_cmpt': 1, 'sistema': 'SIA', 'total': 5898}
  SQL: `SELECT 
  mes_cmpt,
  COUNT(*) AS total_ortopedico
FROM processed
