...
Exemplos de SQL e estatisticas exploratorias: os notebooks [exploration.ipynb](../notebooks/exploration.ipynb) e [event-narrative.ipynb](../notebooks/event-narrative.ipynb) sao a fonte de verdade para consultas DuckDB.
