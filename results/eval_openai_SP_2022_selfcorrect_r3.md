...
**Resultado:** `Linha 1: got={'cid_principal': 'T181', 'taxa_mortalidade': 100.0} exp={'cid_principal': 'S062', 'total_internacoes': 70, 'total_obitos': 21.0, 'taxa_mortalidade_pct': 30.0}`
**TTA:** 12149ms
...
**Resultado:** `Linha 1: got={'internacoes_idosos': 19120.0, 'total_internacoes': 29356} exp={'total_s72': 29356, 's72_idosos': 19120.0, 'pct_idosos': 65.1}`
**TTA:** 11854ms
...
- **Q18** (Epidemiológica Complexa): Linha não encontrada: {'faixa_etaria': '0-17', 'total': 3619}
  ...
  CASE
    ...
    WHEN idade_paciente BETWEEN 18 AND 59 THEN '18-59'
    ELSE ...`
- **Q19** (Epidemiológica Complexa): Linha 1: got={'cid_principal': 'T181', 'taxa_mortalidade': 100.0} exp={'cid_principal': 'S062', 'total_internacoes': 70, 'total_obitos': 21.0, 'taxa_mortalidade_pct': 30.0}
  SQL: `SELECT cid_principal,
  ROUND(100.0 * SUM(CASE WHEN morte = 1 THEN 1 ELSE 0 END) / COUNT(DISTINCT n_aih), 2) AS taxa_mor...`
- **Q22** (Epidemiológica Complexa): Linha 1: got={'internacoes_idosos': 19120.0, 'total_internacoes': 29356} exp={'total_s72': 29356, 's72_idosos': 19120.0, 'pct_idosos': 65.1}
  SQL: `SELECT
  SUM(CASE WHEN idade_paciente >= 60 THEN 1 ELSE 0 END) AS internacoes_idosos,
