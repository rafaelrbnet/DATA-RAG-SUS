...
|---|---|
| Total queries | 50 |
| Correct (EA numerator) | 5 |
| **Execution Accuracy (EA)** | **10.0%** |
...
| Financeira | 0 | 10 | 0.0% |
| Temporal/Comparativa | 1 | 10 | 10.0% |
...
**Resultado:** `Linha 1: got={'mes_cmpt': 1, 'quantidade_internacoes': 2220} exp={'mes_cmpt': 1, 'fraturas_femur': 2220}`
**TTA:** 34620ms
...
- **Q49** (Temporal/Comparativa): Linha 1: got={'mes_cmpt': 1, 'quantidade_internacoes': 2220} exp={'mes_cmpt': 1, 'fraturas_femur': 2220}
  SQL: `SELECT 
    mes_cmpt,
    COUNT(*) AS quantidade_internacoes
FROM 
